"""
Launch file for smart warehouse simulation.
Spawns Gazebo world + 3 warehouse robots at different positions.
"""
...
def generate_launch_description():
    ...
    world_file = os.path.join(gazebo_world_pkg, 'worlds', 'smart_warehouse.world')
    ...
    robots = [
        {'name': 'robot1', 'x': '-6.5', 'y': '4.5', 'z': '0.1', 'yaw': '0.0'},
        {'name': 'robot2', 'x': '-6.5', 'y': '1.5', 'z': '0.1', 'yaw': '0.0'},
        {'name': 'robot3', 'x': '-6.5', 'y': '-1.5', 'z': '0.1', 'yaw': '0.0'},
    ]
